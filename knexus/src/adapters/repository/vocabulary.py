...
# `_fold()` en enrichment.py quita acentos de ambos lados al comparar, así que
# una sola forma acentuada por frase basta (no hace falta duplicar sin acentos).
METHOD_PHRASES = {
...
# Frase -> tipo de problema inferido del texto de una necesidad (NEED).
...
# Frase del texto de un NEED -> sector institucional inferido.
NEED_SECTOR_PHRASES = {
