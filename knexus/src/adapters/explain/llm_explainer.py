...
class LlmExplainer(Explainer):
    ...
    def _connection_prompt(self, connection) -> str:
        ...
        return (
            ...
            "los provistos. No agregues ningún título ni prefijo (por ejemplo, nunca escribas "
            "'Explicación generada:') — la pantalla ya lo etiqueta como generado por IA. "
            "Responde en texto plano, sin markdown: nada de **negritas**, #, ni guiones de "
            "lista.\n\n"
    ...
    def _opportunity_prompt(self, opportunity) -> str:
        ...
        return (
            ...
            "provistos. No agregues ningún título ni prefijo (por ejemplo, nunca escribas "
            "'Explicación generada:') — la pantalla ya lo etiqueta como generado por IA. "
            "Responde en texto plano, sin markdown: nada de **negritas**, #, ni guiones de "
            "lista.\n\n"
    ...
    def _comparison_prompt(self, comparison) -> str:
        ...
        return (
            ...
            "paréntesis abajo. No agregues ningún título ni prefijo (por ejemplo, nunca "
            "escribas 'Explicación generada:') — la pantalla ya lo etiqueta como generado "
            "por IA. Responde en texto plano, sin markdown: nada de **negritas**, #, ni "
            "guiones de lista.\n\n"
