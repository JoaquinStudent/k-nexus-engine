...
| **Sprint-08** | Empaque de entregables (README, diagrama, declaración) | ✅ Done | `README.md` de raíz con las 10 secciones exigidas (`DESAFÍO_Educación.md §ENTREGABLES`) · diagrama Mermaid en §2 corregido para reflejar el modelo real (`ARCHITECTURE.md` decía `bge-m3` en 4 sitios; se alinearon a `paraphrase-multilingual-MiniLM-L12-v2`) · `docs/DECLARACION_TECNOLOGICA.md` (entregable #7) · `docs/CASOS_DEMOSTRABLES.md` (entregable #6, 3 casos EJECUTADOS con el modelo real el 2026-08-27, salida literal pegada, no redactada) · `requirements.txt` con versiones fijadas y verificado con instalación limpia en venv nuevo (166/166 tests) · checklist de la guía §11 respondido con evidencia enlazada. |
